...
const Home = () => {
  return (
    <div name="home" className=' h-screen w-full bg-gradient-to-b from-black to-gray-800 pb-11'>
        
        <div className='max-w-screen-lg  mx-5  flex flex-col items-center justify-center h-full  text-white px-4 md:flex-row'>
...
<span className='hover:rotate-90 duration-500'>
    <MdOutlineKeyboardArrowRight size={25} className='ml-1'/>
            ...
            <div className=' mt-2' >
        <img src={pic} alt="raajkumar" className='rounded-2xl w-auto h-56 overflow-hidden md:w-full   hover:scale-110' />
